        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem className="cursor-pointer capitalize">
              <div className="size-9 relative overflow-hidden bg-[#616061] text-white font-semibold text-xl flex items-center justify-center mr-2">
          ...
          <DropdownMenu>
            <div className="flex items-center gap-0.5">
              <Hint label="Filler conversations" side="bottom">
