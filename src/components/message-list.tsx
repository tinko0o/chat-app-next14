...
const fomatDatelabel = (dateStr: string) => {
...
export const MessageList = ({
  ...
  const { data: currentNember } = useCurrentMember({ workspaceId });
          ...
          {messages.map((message, index) => {
            ...
            return (
              <Message
                ...
                isAuthor={message.memberId === currentNember?._id}
